...
class Filter(BaseModel):
    ...
    _attacker_alliance_ids_include: list[int] = field(default_factory=list)
    _attacker_alliance_ids_exclude: list[int] = field(default_factory=list)
    _attacker_character_ids_include: list[int] = field(default_factory=list)
    _attacker_character_ids_exclude: list[int] = field(default_factory=list)
    _attacker_corporation_ids_include: list[int] = field(default_factory=list)
    _attacker_corporation_ids_exclude: list[int] = field(default_factory=list)
    _attacker_faction_ids_include: list[int] = field(default_factory=list)
    _attacker_faction_ids_exclude: list[int] = field(default_factory=list)

    _attacker_ship_category_ids_include: list[int] = field(default_factory=list)
    _attacker_ship_category_ids_exclude: list[int] = field(default_factory=list)
    _attacker_ship_group_ids_include: list[int] = field(default_factory=list)
    _attacker_ship_group_ids_exclude: list[int] = field(default_factory=list)
    _attacker_ship_type_ids_include: list[int] = field(default_factory=list)
    _attacker_ship_type_ids_exclude: list[int] = field(default_factory=list)

    _attacker_weapon_category_ids_include: list[int] = field(default_factory=list)
    _attacker_weapon_category_ids_exclude: list[int] = field(default_factory=list)
    _attacker_weapon_group_ids_include: list[int] = field(default_factory=list)
    _attacker_weapon_group_ids_exclude: list[int] = field(default_factory=list)
    _attacker_weapon_type_ids_include: list[int] = field(default_factory=list)
    ...
    _victim_alliance_ids_include: list[int] = field(default_factory=list)
    _victim_alliance_ids_exclude: list[int] = field(default_factory=list)
    _victim_character_ids_include: list[int] = field(default_factory=list)
    _victim_character_ids_exclude: list[int] = field(default_factory=list)
    _victim_corporation_ids_include: list[int] = field(default_factory=list)
    _victim_corporation_ids_exclude: list[int] = field(default_factory=list)
    _victim_faction_ids_include: list[int] = field(default_factory=list)
    _victim_faction_ids_exclude: list[int] = field(default_factory=list)

    _region_ids_include: list[int] = field(default_factory=list)
    _region_ids_exclude: list[int] = field(default_factory=list)
    _constellation_ids_include: list[int] = field(default_factory=list)
    _constellation_ids_exclude: list[int] = field(default_factory=list)
    _system_ids_include: list[int] = field(default_factory=list)
    _system_ids_exclude: list[int] = field(default_factory=list)

    _location_ids_include: list[int] = field(default_factory=list)
