...
from core.tasks.ESI.GetCharacterPublicInfo import ApiGetCharacterPublicInfo
from core.tasks.ESI.GetCorporationInfo import ApiGetCorporationInfo
from core.tasks.ESI.GetAllianceInfo import ApiGetAllianceInfo
